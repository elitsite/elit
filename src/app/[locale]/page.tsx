...
export default async function Home({
  ...
  return (
    <main>
      ...
      <section className="relative w-full min-h-[80vh] sm:min-h-[90vh] flex flex-col items-center justify-center text-center overflow-hidden">
        {/* Background image — logo3 on mobile, logo2 on desktop */}
        <Image
          src="/logo3.png"
          alt="Alya Bloemen"
          fill
        ...
        {/* Content on top */}
        <div className="relative z-10 flex flex-col items-center px-6 py-16 sm:py-24">
